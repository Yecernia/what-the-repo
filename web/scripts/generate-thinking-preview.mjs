...
const font = fs.readFileSync(path.join(root,'public/fonts/JasonHandwriting6p.woff2')).toString('base64');
...
<style>
@font-face{font-family:Jason;src:url(data:font/woff2;base64,${font}) format('woff2');font-weight:400;font-style:normal;font-display:swap}
