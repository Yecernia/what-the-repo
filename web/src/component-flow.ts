...
const SHARED_SUPPORT_LAYER_ID = 'layer:shared-support';
const LAYER_NODE_WIDTH = 320;
const LAYER_NODE_HEIGHT = 188;
...
function leafComponents(snapshot: Snapshot): GraphNode[] {
