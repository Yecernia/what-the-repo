...
环境配置与部署背景见[开发说明](DEVELOPMENT.zh-CN.md)。
...
新增依赖时请说明用途。修改依赖或第三方素材时，同步更新锁文件、许可清单和相关声明，保留已有版权及修改说明。清单记录了依赖描述文件的准确摘要，文件变化后会提示记录过期。具体要求见[许可记录维护](licenses/README.zh-CN.md)。
